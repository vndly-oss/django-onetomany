...
class OneToManyField(models.ManyToManyField):
    """A foreign key field that behaves just like Django's ManyToMany field,
    ...
    def contribute_to_class(self, cls, name):
        ...
        if auto_intermediate == True:
            ...
            self.remote_field.through._meta.unique_together = (
                (self.remote_field.through._meta.unique_together[0][1],),
            )
